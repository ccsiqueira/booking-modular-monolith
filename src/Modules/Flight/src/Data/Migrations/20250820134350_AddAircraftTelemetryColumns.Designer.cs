...
namespace Flight.Data.Migrations
{
    ...
    [Migration("20250820134350_AddAircraftTelemetryColumns")]
    partial class AddAircraftTelemetryColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flight.Aircrafts.Models.Aircraft", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTelemetryUpdate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_telemetry_update");
            ...
            modelBuilder.Entity("Flight.Aircrafts.Models.Aircraft", b =>
                {
                    b.OwnsOne("Flight.Aircrafts.ValueObjects.Attitude", "CurrentAttitude", b1 =>
                        {
                            ...
                            b1.Property<double>("Pitch")
                                ...
                                .HasColumnName("current_attitude_pitch");

                            b1.Property<double>("Roll")
                                .HasPrecision(18, 6)
                                .HasColumnType("double precision")
                                .HasColumnName("current_attitude_roll");

                            b1.Property<double>("Yaw")
                                .HasPrecision(18, 6)
                                .HasColumnType("double precision")
                                .HasColumnName("current_attitude_yaw");
                    ...
                    b.OwnsOne("Flight.Aircrafts.ValueObjects.Position", "CurrentPosition", b1 =>
                        {
                            b1.Property<Guid>("AircraftId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<double>("Altitude")
                                .HasPrecision(18, 2)
                                .HasColumnType("double precision")
                                .HasColumnName("current_position_altitude");

                            b1.Property<double>("Latitude")
                                .HasPrecision(18, 6)
                                .HasColumnType("double precision")
                                .HasColumnName("current_position_latitude");

                            b1.Property<double>("Longitude")
                                .HasPrecision(18, 6)
                                .HasColumnType("double precision")
                                .HasColumnName("current_position_longitude");
                    ...
                    b.OwnsOne("Flight.Aircrafts.ValueObjects.TelemetryData", "CurrentTelemetry", b1 =>
                        {
                            b1.Property<Guid>("AircraftId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<string>("FlightPhase")
                                .IsRequired()
                                .HasMaxLength(20)
                                .HasColumnType("character varying(20)")
                                .HasColumnName("current_telemetry_flight_phase");

                            b1.Property<double>("FuelLevel")
                                .HasPrecision(18, 2)
                                .HasColumnType("double precision")
                                .HasColumnName("current_telemetry_fuel_level");

                            b1.Property<double>("Heading")
                                .HasPrecision(18, 2)
                                .HasColumnType("double precision")
                                .HasColumnName("current_telemetry_heading");

                            b1.Property<double>("Speed")
                                .HasPrecision(18, 2)
                                .HasColumnType("double precision")
                                .HasColumnName("current_telemetry_speed");
                    ...
                    b.Navigation("CurrentAttitude");

                    b.Navigation("CurrentPosition");

                    b.Navigation("CurrentTelemetry");
